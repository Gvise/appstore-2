    ...
    <div class="container">
        <div class="unround panel panel-default unround" style="margin:50px 0 0 240px;width:500px;">
            ...
            <div class="panel-body">
                <form action=<?= url('deposit') ?> class="form-inline" style="margin-left:20px;" method="post">
                ...
                <code class="text-info bg-info unround" style="margin:0 20px 0 20px;display:block;width:90%;">
                    <span>Please transfer deposit amount to the address below.</span><br>
                    <span><?= $billingAddress ?></span><br><br>
                    <span>Your balance will be updated as soon as the transition is complete.</span>
                </code>
            </div>
        </div>
